...
export type Mutation = {
  ...
  deleteManyPagesConnection: AboutConnection;
  /**
  ...
  /** Publish many About documents */
  publishManyPagesConnection: AboutConnection;
  /**
  ...
  unpublishManyPagesConnection: AboutConnection;
  /**
  ...
  updateManyPagesConnection: AboutConnection;
  /**
   * Update many places
...
export type Query = {
  ...
  pagesConnection: AboutConnection;
...
export type ScheduledOperationAffectedDocument = About | Asset | Place;
...
export type GetPagesQuery = { __typename?: 'Query', pages: Array<{ __typename?: 'About', id: string, heading?: string | null | undefined, slug: string, body: { __typename?: 'RichText', html: string } }> };
